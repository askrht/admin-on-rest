...
export class ReferenceAutocompleteInput extends Component {
    componentDidMount() {
...
const ConnectedReferenceAutocompleteInput = connect(mapStateToProps, {
    crudGetOne: crudGetOneAction,
    crudGetMatching: crudGetMatchingAction,
})(ReferenceAutocompleteInput);

ConnectedReferenceAutocompleteInput.defaultProps = {
    includesLabel: true,
};

export default ConnectedReferenceAutocompleteInput;
